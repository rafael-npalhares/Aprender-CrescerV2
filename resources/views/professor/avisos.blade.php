{{-- resources/views/professor/avisos.blade.php --}}
{{-- Rota: professor.avisos | Controller: ProfessorController@avisos --}}
{{-- Esperado: $avisos (paginado, já filtrado por visivel_para = 'professores' ou 'todos') --}}
