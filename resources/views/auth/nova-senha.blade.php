...
<body>
    ...
    <div class="panel-left">
        ...
        <div class="panel-tagline">
            ...
            <p>Identidade verificada com sucesso. Agora escolha uma senha forte para sua conta.</p>
        </div>
    ...
    <div class="panel-right">
        <div class="card-form">
            ...
            <p class="subtitle">
                Identidade confirmada. Digite e confirme sua nova senha abaixo.
            </p>
            ...
            {{-- action="route('salvar.nova.senha')" chama ResetSenhaController@salvar --}}
            <form method="POST" action="{{ route('salvar.nova.senha') }}" novalidate>
                @csrf
