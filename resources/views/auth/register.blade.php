    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .form-control, .form-select {
            ...
            border-radius: 10px; font-size: .92rem; color: var(--text); background: #fff; transition: border-color .2s, box-shadow .2s;
        }
        ...
        .toggle-pw { position: absolute; right: 14px; top: 50%; transform: translateY(-50%); background: none; border: none; cursor: pointer; color: var(--muted); font-size: 1rem; z-index: 2; padding: 0; }
        ...
        .btn-register {
            ...
            font-weight: 600; font-size: .95rem; letter-spacing: .02em; transition: background .2s, transform .15s; cursor: pointer; margin-top: .5rem;
        }
        .btn-register:hover { background: #1e5ce6; transform: translateY(-1px); }
        .btn-register:active { transform: translateY(0); }
        .link-voltar { display: block; text-align: center; font-size: .85rem; color: var(--muted); margin-top: 1.25rem; text-decoration: none; transition: color .15s; }
...
<body>
    ...
    <div class="panel-left">
        ...
        <div class="panel-tagline">
            ...
            <p>Preencha os dados ao lado para criar uma conta de aluno ou professor no sistema.</p>
        </div>
            ...
            <form action="{{ route('register') }}" method="POST" novalidate>
                ...
                <div class="input-group-custom">
                    ...
                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                           value="{{ old('name') }}" placeholder="Nome completo do usuário" autofocus autocomplete="name">
                ...
                <div class="input-group-custom">
                    ...
                    <input type="email" name="email" class="form-control @error('email') is-invalid @enderror"
                           value="{{ old('email') }}" placeholder="email@exemplo.com" autocomplete="email">
    ...
    <script>
        ...
        function avaliarSenha(val) {
            ...
            if (!val) return;
            if (val.length < 6) bar.classList.add('fraca');
            else if (val.length < 10 || !/[A-Z]/.test(val) || !/[0-9]/.test(val)) bar.classList.add('media');
