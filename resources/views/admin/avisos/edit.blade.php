...
<div class="card" style="max-width: 700px;">
    <div style="padding: 28px;">
        <form action="{{ route('admin.avisos.update', $aviso) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                ...
                <textarea id="conteudo" name="conteudo" rows="5"
                          ...
                          required>{{ old('conteudo', $aviso->conteudo) }}</textarea>
            ...
            <div class="form-group">
                ...
                <select id="visivel_para" name="visivel_para"
                    ...
                    <option value="todos"      {{ old('visivel_para', $aviso->visivel_para) === 'todos'       ? 'selected' : '' }}>Todos</option>
                    <option value="professores"{{ old('visivel_para', $aviso->visivel_para) === 'professores' ? 'selected' : '' }}>Professores</option>
                    <option value="alunos"     {{ old('visivel_para', $aviso->visivel_para) === 'alunos'      ? 'selected' : '' }}>Alunos</option>
                </select>
            ...
            <div class="form-group">
                ...
                <input type="date" id="data_expiracao" name="data_expiracao"
                       ...
                       value="{{ old('data_expiracao', $aviso->data_expiracao) }}">
            ...
            <div class="form-group">
                <label style="display:flex; align-items:center; gap:8px; cursor:pointer;">
                    <input type="checkbox" name="fixado" value="1"
                           ...
                           {{ old('fixado', $aviso->fixado) ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <label style="display:flex; align-items:center; gap:8px; cursor:pointer;">
                    ...
                    <span class="form-label" style="margin:0;">Aviso ativo</span>
                </label>
            </div>
