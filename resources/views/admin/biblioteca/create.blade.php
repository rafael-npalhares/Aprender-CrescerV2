{{-- resources/views/admin/biblioteca/create.blade.php --}}
...
<div class="form-header">
    ...
    <div class="form-header-text">
        <h1>Novo livro</h1>
        <p>Preencha os dados para adicionar ao acervo.</p>
    </div>
</div>

<div class="form-card">
    <form action="{{ route('admin.biblioteca.livros.store') }}" method="POST">
        @csrf
