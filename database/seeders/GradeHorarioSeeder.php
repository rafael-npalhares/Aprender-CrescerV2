...
class GradeHorarioSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Busca professores pelo user relacionado
        ...
        // Grade da Turma 1A — exemplo completo de uma semana
        // aula: 1=7h, 2=8h, 3=9h, 4=10h, 5=11h, 6=13h (referência visual na view)
        $grade = [
            // Segunda
